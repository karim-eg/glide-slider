...
import co.encept.slider.indicators.PagerIndicator;
import co.encept.slider.slidertypes.BaseSliderView;
import co.encept.slider.transformers.AccordionTransformer;
import co.encept.slider.transformers.BackgroundToForegroundTransformer;
import co.encept.slider.transformers.BaseTransformer;
import co.encept.slider.transformers.CubeInTransformer;
import co.encept.slider.transformers.DefaultTransformer;
import co.encept.slider.transformers.DepthPageTransformer;
import co.encept.slider.transformers.FadeTransformer;
import co.encept.slider.transformers.FlipHorizontalTransformer;
import co.encept.slider.transformers.FlipPageViewTransformer;
import co.encept.slider.transformers.ForegroundToBackgroundTransformer;
import co.encept.slider.transformers.RotateDownTransformer;
import co.encept.slider.transformers.RotateUpTransformer;
import co.encept.slider.transformers.StackTransformer;
import co.encept.slider.transformers.TabletTransformer;
import co.encept.slider.transformers.ZoomInTransformer;
import co.encept.slider.transformers.ZoomOutSlideTransformer;
import co.encept.slider.transformers.ZoomOutTransformer;
import co.encept.slider.tricks.FixedSpeedScroller;
import co.encept.slider.tricks.InfinitePagerAdapter;
import co.encept.slider.tricks.InfiniteViewPager;
...
public class SliderLayout extends RelativeLayout {
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*
      {@link co.encept.slider.Tricks.ViewPagerEx} transformer time span.
     */
     ...
     *
     * @param duration the slider duration
     */
    ...
    /**
     * set slider transformer animation
     *
     * @param ts {@link Transformer}
     */
